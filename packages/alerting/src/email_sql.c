 ...
 */
 ...
 /*
 Function        : MysqlSelectAsRow
 Description    : Execute mysql sentence and store the result,should call mysql_free_result after this function in case of memory leak.
 Arguments     : sql->mysql sentence;
                       result->pointer to the address that store the result.
 Returns         : 0 ->success,-1->fail.
 */
